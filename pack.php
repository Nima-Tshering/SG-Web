...
<!--/single_page-->
       <!-- /banner_bottom_agile_info -->
			 <?php
			 	$id=$_GET['id'];
     $sql="SELECT * FROM `pakage` WHERE `id`='$id'";
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3><?php  echo $row['name'];?> <span>Page </span></h3>
			<!--/w3_short-->
...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price">₹<?php echo $row['price']?></span> <del>- ₹<?php echo $row['dprice'];?></del></p>
					<div class="rating1">
						   ...
						   <div class="tab3">
							...
							<div class="single_page_agile_its_w3ls">
							  <h6>Information</h6>
							   ...
							   <p class="w3ls_para"><?php echo $row['info'];?></p>
							</div>
						</div>
					</div>
				</div>
