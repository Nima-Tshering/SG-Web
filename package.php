...
<div class="col-md-3 product-men">
	<div class="men-pro-item simpleCart_shelfItem">
			...
			<img src="images/<?php echo $row['img1'];?>" alt="" class="pro-image-back">
				<div class="men-cart-pro">
					<div class="inner-men-cart-pro">
						<a href="pack.php?id=<?php echo $row['id']; ?>" class="link-product-add-cart">Quick View</a>
					</div>
				</div>
		...
		<div class="item-info-product ">
			<h4 style="color:#ff6666">	<a href="pack.php?id=<?php echo $row['id']; ?>"></a><?php  echo $row['name'];?></a></h4>
